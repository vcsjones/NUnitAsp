   ...
   ///     <item><term>sys.os</term>              <description>Operating system version string.</description></item>
    ...
    public class SysInfoTask : Task {
        ...
        protected override void ExecuteTask() {
            ...
            // set properties
            Project.Properties.Add(Prefix + "clr.version", Environment.Version.ToString());
            Project.Properties.Add(Prefix + "os.platform", Environment.OSVersion.Platform.ToString());
            Project.Properties.Add(Prefix + "os.version", Environment.OSVersion.Version.ToString());
            Project.Properties.Add(Prefix + "os.folder.system", Environment.GetFolderPath(Environment.SpecialFolder.System));
            Project.Properties.Add(Prefix + "os.folder.temp", Path.GetTempPath());
            ...
            foreach (string name in variables.Keys) {
                ...
                Project.Properties.Add(Prefix + "env." + name, value);
            }

            // display the properties
            if (Verbose) {
                Log.WriteLine(LogPrefix + "nant.version = " + Project.Properties["nant.version"]);
