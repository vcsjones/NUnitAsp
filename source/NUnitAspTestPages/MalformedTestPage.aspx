...
<html>
	...
	<body MS_POSITIONING="GridLayout" single-quoted='some"text'>
		...
		<form id="MalformedTestPage" method="post" runat="server">
			...
			<br>
			Some meta tag attributes are missing their double quotes. Body attribute
			has one single-quoted attribute value containg a single double-quote character
			<br>
			<br>
			It's typical of a page generated by Visual Studio .NET, and NUnitAsp must be able to 
			test it.
			<br>
			<br>
			...
			<ul>
				...
				or will it work?</li>
				<li>An unterminated item
				<li>yet another one
			</ul>
			Another badly formatted element
